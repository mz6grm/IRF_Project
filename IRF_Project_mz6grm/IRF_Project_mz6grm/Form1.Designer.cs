namespace IRF_project_mz6grm
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox2
			// 
			this.textBox2.Location = new System.Drawing.Point(396, 213);
			...
			this.label3.Size = new System.Drawing.Size(831, 46);
			this.label3.TabIndex = 4;
			this.label3.Text = "Welcome to the World Happiness Dashboard!";
			// 
			// label4
			// 
			...
			this.label4.Text = "Please Login to check the visualization!";
			// 
			// label5
			// 
			...
			this.label5.Text = "If you don\'t have an account Register.";
			// 
			// button1
			// 
			...
			this.button3.Location = new System.Drawing.Point(700, 403);
			...
			this.label6.Location = new System.Drawing.Point(548, 289);
			...
			this.label7.Text = "*Data downloaded from: https://worldhappiness.report/";
			// 
			// Form1
			// 
